...
const FAQs1 = ({ header, tabs }: FAQsProps) => {
  ...
  return (
    <section className="bg-primary-50 dark:bg-slate-800" id="faqsFive">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-10">
        {header && <HeaderWidget header={header} titleClassname="text-3xl sm:text-4xl" />}
        <div className="flex items-stretch justify-center">
          <div className="grid w-full md:grid-cols-1 md:items-center md:gap-0">
            {width > 767 ? (
